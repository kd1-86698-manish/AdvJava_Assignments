...
public class ResultServlet extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest req, HttpServletResponse resp)
		...
		out.println("<style>");
		out.println("h1 { color: #555; font-size: 18px; margin-bottom: 20px; }");
		out.println(
		...
		for (Candidate c : list) {
			...
			out.printf("<td  class='actions'>");
			out.printf("<a  href='editcand?id=%d'><img src='images/edit.png' alt='Edit' width='24' height='24'/></a>\n",
					c.getId());
			out.printf(
					"<a  href='delcand?id=%d'><img src='images/delete.png' alt='Edit' width='24' height='24'/></a>\n",
					c.getId());
			out.printf("</td  class='actions'>\n");
			out.println("</tr>");
		}
		...
		out.println("<p><a href='annoucement.html'>Annoucement</a></p>");
